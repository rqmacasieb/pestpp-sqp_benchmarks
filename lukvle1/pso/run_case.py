"""
Run the LUKVLE1 PESTPP-MOU/PSO cases built by build_case.py on this computer.
...
Usage:
    ...
    python run_case.py 20 --exe /path/to/pestpp-mou --num_workers 8
...
EXE_NAME = "pestpp-mou"
BASE_PORT = 4400  # seed N of an n-variable case listens on BASE_PORT + 100 * n + N (unique per case and seed)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="run the LUKVLE1 PESTPP-MOU/PSO cases locally")
