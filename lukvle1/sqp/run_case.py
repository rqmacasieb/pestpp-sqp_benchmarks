"""
Run the LUKVLE1 PESTPP-SQP cases built by build_case.py on this computer.
...
Usage:
    ...
    python run_case.py 20 --exe /path/to/pestpp-sqp --num_workers 8
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="run the LUKVLE1 PESTPP-SQP cases locally")
