"""
Run the Powell PESTPP-OPT cases built by build_case.py on this computer.
...
Usage:
    ...
    python run_case.py 48 --exe /path/to/pestpp-opt --num_workers 8
...
EXE_NAME = "pestpp-opt"
BASE_PORT = 5500  # seed N of an n-variable case listens on BASE_PORT + 100 * n + N (unique per case and seed)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="run the Powell PESTPP-OPT cases locally")
