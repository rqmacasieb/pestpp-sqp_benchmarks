"""
Run the Rosenbrock PESTPP-OPT cases built by build_case.py on this computer.
...
Usage:
    ...
    python run_case.py 50 --exe /path/to/pestpp-opt --num_workers 8
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="run the Rosenbrock PESTPP-OPT cases locally")
